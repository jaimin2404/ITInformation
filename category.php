    ...
    <div class="main index">
        <div class="main-content">
            <div class="container">
                ...
                $qryPagination = "SELECT * FROM category WHERE categoryId={$catId}";
                ...
                $offset = ($page - 1) * $limit;
                $sql = "SELECT post.postId,post.postTitle,post.postDescription,post.postDate,post.postImage,post.postAuthor,category.categoryId,category.categoryName,user.userName,user.name FROM post LEFT JOIN category ON post.postCategory = category.categoryId LEFT JOIN user ON post.postAuthor = user.userId WHERE post.postCategory = {$catId} ORDER BY post.postId DESC LIMIT {$offset},{$limit}";
